$(document).ready(function () {
  ...
  //dual line chart
  if ($("#lineChart_3Kk").length > 0) {
    if ($(window).width() < 991) {
      $("#lineChart_3Kk").removeAttr("height");
    }
